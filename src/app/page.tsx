...
import { getFlagEmoji, SearchIcon, ChevronDownIcon, ChevronRightIcon, UserIcon } from "@/lib/agentUi";
...
export default function Home() {
  ...
  return (
    <main className="mx-auto max-w-[1600px] px-8 py-8">
      ...
      <section className="rounded-2xl bg-gray-200/60 p-10">
        ...
        <div className="relative mx-auto mt-8 max-w-3xl">
          <div className="flex overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2">
            <div className="flex items-center gap-2 border-r border-gray-200 px-4 py-3 text-gray-500">
              <SearchIcon />
