// Login page UI: clean modern design matching the app's indigo/gray theme
"use client";
...
export default function LoginPage() {
  ...
  // Submit credentials to Auth.js; redirect home on success
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res?.error) {
      ...
      router.push("/");
      router.refresh(); // Refresh so the server picks up the new session
    }
  };
    ...
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gray-100 px-4">
      ...
      >
        ...
        <p className="mt-2 text-center text-sm text-gray-500">
          Sign in to <span className="font-semibold text-indigo-600">Skyforge Agents</span>
        </p>
